...
export default class extends Controller {
  ...
  send_everything() {
    ...
    document.querySelector(".message").innerHTML = "<h1>Items you must buy! 🛒</h1><h6 data-shopping-to-pantry-target='message' style='font-size: 14px; color: grey; margin-bottom: 20px; margin-left: 3px;'>You have everything in stock!</p>"
  }
